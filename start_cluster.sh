...
docker -H 10.0.7.12:2375 run -d --restart always --name swarm_node1 swarm join --heartbeat 20s --advertise 10.0.7.12:2375 consul://10.0.7.10:8500
docker -H 10.0.7.13:2375 run -d --restart always --name swarm_node2 swarm join --heartbeat 20s --advertise 10.0.7.13:2375 consul://10.0.7.10:8500
